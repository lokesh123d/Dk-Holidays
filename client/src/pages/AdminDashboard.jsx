...
import { carService, bookingService, authService, contactService, reviewService, offerService } from '../services/apiService';
                            ...
                            {activeTab === 'cars' && (
                                <div className="admin-section">
                                    <div className="section-header">
                                        <h1>Manage Cars</h1>
                                        <button className="add-btn" onClick={() => setShowAddCarModal(true)}>
                    ...
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleAddCar} className="admin-form">
                            ...
                            <div className="form-actions">
                                <button type="button" className="btn-secondary" onClick={() => setShowAddCarModal(false)}>
                                    Cancel
                                </button>
